...
namespace WTFJimGameProject.GameWindows
{
    ...
    class MenuPanel2D : PanelComponent2D
    {
        ...
        /// <summary>
        /// Creates a menu from an existing panel. The panel you pass in must have the menu items inserted
        /// in order otherwise selection and highlighting will not work. Default font selected color is Yellow.
        /// </summary>
        ...
        /// <summary>
        /// Creates a menu from an existing panel. The panel you pass in must have the menu items inserted
        /// in order otherwise selection and highlighting will not work.
        /// </summary>
        /// <param name="panel">Menu components</param>
        ...
        public string GetCursorSelectedText(Point cursorPosition)
        {
            ...
            foreach (Component item in panelItems)
            {
                ...
                if (item is TextComponent2D)
                {
                    ...
                    Rectangle rect = new Rectangle((int)textItem.Position.X, (int)textItem.Position.Y, (int)size.X, (int) size.Y);

...
namespace TheGame
{
    ...
    {
        public Hurricane(GameScreen parent, SpellInfo spellInfo, Vector3 target)
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (timeElpase > 10)
            {
                ...
                {
                    vortex.AddParticle(new Vector3(r * (float)random.NextDouble() * scale, theta * (float)random.NextDouble(), 0.0f), new Vector3(0.6f, 4.0f, 3.0f), 0.2f, 1.3f, Color.Thistle, null);
                }
            }
        }
    }

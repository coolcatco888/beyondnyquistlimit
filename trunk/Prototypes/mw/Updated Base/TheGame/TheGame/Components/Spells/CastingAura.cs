...
namespace TheGame
{
    public class CastingAura : Spell
    {
        ...
        public CastingAura(GameScreen parent, Library.SpellInfo spellInfo, Component3D caster, Component3DList targets, Point sheetIndex)
        ...
        public CastingAura(GameScreen parent, Library.SpellInfo spellInfo, Component3D caster, Component3DList targets, int sheetColumn, int sheetRow)
            : base(parent, spellInfo, caster, targets)
        {

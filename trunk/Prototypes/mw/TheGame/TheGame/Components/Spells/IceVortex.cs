...
namespace TheGame
{
    public class IceVortex : Spell
    {
        ...
        public override void Initialize()
        {
            ...
            settings.Scale = 1.0f;
            settings.SpriteTexture = GameEngine.Content.Load<Texture2D>("ParticleD");
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (timeElpase > 10)
            {
                ...
                {
                    vortex.AddParticle(new Vector3(r * (float)random.NextDouble() * scale, theta * (float)random.NextDouble(), 0.0f), new Vector3(0.6f, 4.0f, 3.0f));
                }
            }
        }
    }

...
namespace TheGame
{
    public class Billboard : CollidableComponent, IBillboard
    {
        ...
        public void UpdateVertices(Vector2 frameLocation, Vector2 spriteUnit, Vector2 unitScale)
        {
            this.scale.X = scale.X;

            vertices[0].TextureCoordinate = new Vector2(
                frameLocation.X * spriteUnit.X,
                frameLocation.Y * spriteUnit.Y + spriteUnit.Y * unitScale.Y);
            ...
            vertices[2].TextureCoordinate = new Vector2(
                frameLocation.X * spriteUnit.X + spriteUnit.X * unitScale.X,
                frameLocation.Y * spriteUnit.Y + spriteUnit.Y * unitScale.Y);

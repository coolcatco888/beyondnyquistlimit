...
namespace TheGame
{
    class Actor : Billboard
    {
        ...
        public void AddBasicSequences()
        {
            ...
            animations.Add("IdleWest", new SpriteSequence("Idle", Orientation.West, 0, 2, 0, 0, false, true));
            animations.Add("IdleNorthwest", new SpriteSequence("Idle", Orientation.Northwest, 0, 3, 0, 0, false, true));
            animations.Add("IdleNorth", new SpriteSequence("Idle", Orientation.North, 0, 4, 0, 0, false, true));
            animations.Add("IdleNortheast", new SpriteSequence("Idle", Orientation.Northeast, 0, 5, 0, 0, false, true));
            animations.Add("IdleEast", new SpriteSequence("Idle", Orientation.East, 0, 6, 0, 0, false, true));
            animations.Add("IdleSoutheast", new SpriteSequence("Idle", Orientation.Southeast, 0, 7, 0, 0, false, true));

            // Walking
            animations.Add("WalkingSouth", new SpriteSequence("Walking", Orientation.South, 0.8f, 0, 1, 8, true, true));
            animations.Add("WalkingSouthwest", new SpriteSequence("Walking", Orientation.Southwest, 0.4f, 1, 1, 8, true, true));
            animations.Add("WalkingWest", new SpriteSequence("Walking", Orientation.West, 0.4f, 2, 1, 8, true, true));
            animations.Add("WalkingNorthwest", new SpriteSequence("Walking", Orientation.Northwest, 0.4f, 3, 1, 8, true, true));
            animations.Add("WalkingNorth", new SpriteSequence("Walking", Orientation.North, 0.8f, 4, 1, 8, true, true));
            animations.Add("WalkingNortheast", new SpriteSequence("Walking", Orientation.Northeast, 0.4f, 5, 1, 8, true, true));
            animations.Add("WalkingEast", new SpriteSequence("Walking", Orientation.East, 0.4f, 6, 1, 8, true, true));
            animations.Add("WalkingSoutheast", new SpriteSequence("Walking", Orientation.Southeast, 0.4f, 7, 1, 8, true, true));

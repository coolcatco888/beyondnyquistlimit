...
namespace GameStateManagement.GameWindows
{
    ...
    class XMLPanel2DBuilder
    {
        ...
        public XMLPanel2DBuilder(ContentManager content, string file, bool parseNow)
        {
        ...
        public XMLPanel2DBuilder(ContentManager content, string file)
            : this(content, file, true)
        {
        ...
        private void GetPanelPosition()
        {
            ...
            if (attributes.Count == 2)
            {
                ...
                temp = new PanelComponent2D(position);
            }
            panel = temp;
        }
        ...
        private ImageComponent2D CreateImageComponent2d(XmlNodeList attributes)
        {
            ...
            if (attributes.Count == 6)
            {
                ...
                image2d = new ImageComponent2D(position, texture, color);
        ...
        private TextComponent2D CreateTextComponent2d(XmlNodeList attributes)
        {
            ...
            if (attributes.Count == 7)
            {
                ...
                text2d = new TextComponent2D(position, text, color, font);
            }

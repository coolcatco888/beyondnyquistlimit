...
namespace TheGame
{
    class Actor : Billboard
    {
        ...
        private void controller()
        {
            ...
            // OMG ASPLODE!!!
            if (keyboardDevice.WasKeyPressed(Keys.Space))
            {
                SpriteEffect asplode = new SpriteEffect(base.Parent, GameEngine.Content.Load<Texture2D>("sprite_sheet"),
                    64, 64, 0, new SpriteSequence(0, 0, 15, false), this.position, 1);
            }
            // OMG ENDASPLODE!!!
        }
